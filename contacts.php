...
<head>
    ...
    <meta name="description" content="lastSeen contacts page">

    <title>lastSeen | Contacts</title>
...
<body>
    <div class="view">
                    ...
                    <ul class="user-nav nav-group">
                        <li class="nav-object-group">
                            <div class="nav-item logged-out-nav">
                                <a href="?add" class="btn btn-primary btn-login" type="sumbit" name="add">Add Contact</a>
                            </div>
                            <div class="nav-item logged-out-nav">
        ...
        <div class="page container">
            <?php echo Contact::renderContacts(); ?>
        </div>
    </div>
